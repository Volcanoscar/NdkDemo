...
Java_com_android_ndkdemo_MainActivity_stringFromJNI( JNIEnv* env, jobject thiz )
{
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass  clz = (*env)->FindClass(env,
                                    "com/android/ndkdemo/JniHandler");
...
Java_com_android_ndkdemo_MainActivity_startTicks(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_android_ndkdemo_MainActivity_StopTicks(JNIEnv *env, jobject instance) {
